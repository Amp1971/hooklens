    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-blue-500 selection:text-white">
      ...
      <section className="max-w-5xl mx-auto px-6 pt-20 pb-16 text-center space-y-8">
        ...
        <p className="text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed">
          HookLens intercepts failed webhooks across Stripe, PayPal, WooCommerce, Shopify, GitHub and custom APIs, diagnoses the root cause in seconds with AI, and notifies your team directly in Slack & Discord.
        </p>
